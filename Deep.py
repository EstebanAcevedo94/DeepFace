...
while True:
    ...
    if resrostros.detections is not None:
        ...
        for rostro in resrostros.detections:
            ...
            #Dibujamos un rectangulo en el rostro detectado
            cv2.rectangle(frame,(xi, yi),(xf, yf),(255,255,0),1)
            frame[10:ani + 10, 10:ali+10] = img

            # Extraemos la información del primer rostro
            info = DeepFace.analyze(rgb, actions=['age', 'gender', 'race', 'emotion'], enforce_detection=False)[0]
